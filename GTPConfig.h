...
struct GtpConfigElements {
    ...
    void copy(GtpConfigElements *c) {
        ...
        //c->net_path = net_path;
        //c->net_file = net_file;
        c->net_component_path = net_component_path;
...
private:
    ...
    // Random number generation seed
    QPushButton *butt_noiseseed; // use rand() to create
    QLabel *show_noiseseed;
